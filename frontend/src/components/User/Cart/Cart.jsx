            ...
            <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="md:col-span-2 bg-white px-6 py-4">
                    ...
                    <div className="space-y-6">
                        {cartItems.length === 0 ? (
                            <p className="text-center text-gray-500">Your cart is empty, continue shopping</p>
                        ) : (
                            <div className="space-y-6">
                                {cartItems.map((item) => (
                                    <div key={item.id}>
                                        <div className="flex items-start justify-between gap-4">
                                            ...
                                            <div className="flex-1 text-start items-start">
                                                ...
                                                <p className="text-sm text-gray-600">Stock: {item.count}</p>
                                            </div>
                                            <div className="flex flex-col items-end gap-3">
                                                <p className="font-bold text-lg">{(item.price * item.quantity).toFixed(0)} VND</p>
                ...
                <div className="bg-white p-6 rounded shadow-md h-fit">
                    ...
                    <div className="space-y-2 text-sm text-gray-700 mb-4">
                        ...
                        <div className="flex justify-between">
                            ...
                            <span>{delivery.toFixed(0)} VND</span>
                        </div>
                        <div className="flex justify-between">
                            <span>Discount</span>
                            <span>-</span>
